...
//            snippets.filter { $0.mainViewSelection.contains(.mySelection) }.map { $0.snippet }
    ...
    func convertSerialsToSnippetMainVMs(_ serials: [Serial]) -> [SnippetMainViewModel] {
        ...
        for i in serials {
            ...
            if let _ = i.lastSeriesReleaseDate {
                isLastRealese = true
            }
...
extension MainViewModel {
    static let films: [Film] = [
        Film(id: "1", name: "biba1", description: "bobaboba bobabobaboba bobabobabobab obabobabobaboba bobabobabobabobabo babobabobabobab obabobabobabobabobabo babobabobabobab obabobabobabobabobabobabobabobabobaboba", releaseDate: 1698144372325, genre: ["Action"], previewImage: image5, avgRating: 5.0, ageRating: 15, isAnnouncement: false, isFavorite: false, status: "None", country: "США"),
        Film(id: "2", name: "biba2", description: "bobaboba bobabobaboba bobabobabobab obabobabobaboba bobabobabobabobabo babobabobabobab obabobabobabobabobabo babobabobabobab obabobabobabobabobabobabobabobabobaboba", releaseDate: 920241212121, genre: ["Action"], previewImage: image5, avgRating: 4.0, ageRating: 15, isAnnouncement: false, isFavorite: true, status: "Looking"),
        Film(id: "3", name: "biba3", description: "boba3", genre: ["Action"], previewImage: image3, avgRating: 2.0, ageRating: 15, isAnnouncement: true, isFavorite: true, status: "InThePlans", country: "Россия", userRating: 2),
        Film(id: "4", name: "biba4", description: "boba4", releaseDate: 1700315320619, genre: ["Fantasy"], previewImage: image5, avgRating: 4.2,ageRating: 15, isAnnouncement: true, isFavorite: false, status: "None", userRating: 1),
        Film(id: "5", name: "biba5", description: "boba", releaseDate: 1820241212121, genre: ["fantasy"], previewImage: image2, avgRating: 2.5, ageRating: 15, isAnnouncement: true, isFavorite: false, status: "Postponed"),
        Film(id: "6", name: "biba6", description: "boba2", genre: ["Fantasy"], previewImage: image1, avgRating: 3.3, ageRating: 15, isAnnouncement: true, isFavorite: true, status: "Abandoned", country: "Россия"),
        Film(id: "7", name: "biba7", description: "boba3", releaseDate: 1699122213, genre: ["Action"], previewImage: image2, avgRating: 2.6, ageRating: 15, isAnnouncement: false, isFavorite: false, status: "abandoned"),
        Film(id: "8", name: "biba8", description: "boba4", releaseDate: 1702123700619, genre: ["Action", "fantasy"], previewImage: image1, avgRating: 5.0, ageRating: 15, isAnnouncement: true, isFavorite: false, status: "Viewed"),
        Film(id: "9", name: "biba9", description: "boba5", releaseDate: 1703123001619, genre: ["Action", "Fantasy"], previewImage: image2, avgRating: 5.0, ageRating: 15, isAnnouncement: true, isFavorite: true, status: "Viewed", country: "Россия", userRating: 5)
    ]
    
    static let serials: [Serial] = [
        Serial(id: "11", name: "Крокодил Гена выходит на охоту", releaseDate: 1810241212121, description: "Гена шёл-шёл, шёл-шёл, так и не пришёл.", previewImage: image5, avgRating: 3.0, ageRating: 12, genre: ["Action"], isFavorite: false, status: "Viewed", isAnnouncement: true, isOngoing: false, countSeriesLeft: 0, countSeriesMax: 18, country: "Россия"),
        Serial(id: "222", name: "Мышь подкралась незаметно", releaseDate: 1699123761619, description: "Бежит, бежит, оп, упала", previewImage: image1, avgRating: 4.0, ageRating: 12, genre: ["fantasy"], isFavorite: true, status: "Looking", isAnnouncement: false, isOngoing: true, countSeriesLeft: 1, countSeriesMax: 8, country: "Великобритания"),
        Serial(id: "3321", name: "Шарик взорвался", description: "Жалко конечно даааааа", previewImage: image3, avgRating: 5.0, ageRating: 12, genre: ["action"], isFavorite: false, status: "None", isAnnouncement: true, isOngoing: false, countSeriesLeft: 0, countSeriesMax: 8, country: "США"),
        ...
        Serial(id: "54124245", name: "Фунтик толкает машину дядюшки Мокуса", releaseDate: 1823212121, description: "Тянет-потянет, вытащить так и не смог", previewImage: image1, avgRating: 5.0, ageRating: 12, genre: ["Fantasy"], isFavorite: true, status: "postponed", isAnnouncement: false, isOngoing: false, countSeriesLeft: 3, country: "Япония", userRating: 3)
    ]
